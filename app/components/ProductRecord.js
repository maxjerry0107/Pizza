  ...
  render() {
    ...
    return (
      <ImageBackground
        ...
        style={{ flex: 1, paddingTop: 0, resizeMode: "repeat" }}
      >
        <View
          style={{
            flex: 1,
        ...
        >
          <View style={{ flex: 3, flexDirection: "row", alignItems: "center" }}>
            ...
            >
              <Text
                style={[
                  { fontSize: RFPercentage(2.5), fontWeight: "bold" },
                  this.state.count != 0 ? { color: "#0a0" } : { color: "#a00" }
                ]}
              >
              ...
              <Text
                style={[
                  { fontSize: RFPercentage(2.4), fontWeight: "bold" },
                  this.state.count != 0 ? { color: "#0a0" } : { color: "#a00" }
                ]}
              >
                Cost:${this.props.data.cost} X{this.state.count.toString()}
              </Text>
            </View>
            {this.state.count != 0 && (
              <Icon
              ...
              >
                <TouchableOpacity
                  style={[
                    ...
                    this.state.count == 1
                      ? { backgroundColor: "#008c62" }
                      : { backgroundColor: "#8a0400" }
                  ]}
                >
                  <Text
                    style={{ color: "#fff", fontSize: RFPercentage(2.5) }}
                    onPress={() => this.setCount(1)}
                  >
                    Yes
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  ...
                  onPress={() => this.setCount(0)}
                >
                  <Text style={{ color: "#fff", fontSize: RFPercentage(2.5) }}>
                    No
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
