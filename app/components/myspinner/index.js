    ...
    render() {
        ...
        return (
            <View style={[Style.container,
                {borderColor: this.props.showBorder ? 'grey' : 'transparent'},
                ...
                <TextInput
                    style={[Style.numberText, this.props.inputStyle,
                        ...
                        {fontSize: this.props.fontSize},{borderRightWidth:1, borderLeftWidth:1},
                        {borderColor: this.props.showBorder ? this.state.color : 'transparent'},
                        {backgroundColor: this.props.background},
                        {height: this.props.height}]}
                    value={!this.props.types?this.getValue()+"\"":this.getValue()}
