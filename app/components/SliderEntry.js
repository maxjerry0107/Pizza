        ...
        <View style={{flex:1, backgroundColor:'#000', height:'100%'}}>
          ...
          <View style={{flex:1, backgroundColor:'#fff', flexDirection:'column'}}>
            <View style={{flex:4, alignItems:'center', alignContent:'center', justifyContent:'center', paddingHorizontal:20,}}>
              <Text style={{fontSize:22, fontWeight:'bold', marginBottom:10, textAlign:'center'}}>{item.name}</Text>
              <Text style={{fontSize:18, marginBottom:10,}}>{this.convertText(item.description)}</Text>
