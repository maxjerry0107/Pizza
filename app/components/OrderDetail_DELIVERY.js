...
import {View,  ImageBackground,StatusBar,Image,Text,BackHandler,Alert,TextInput, FlatList,TouchableOpacity,ScrollView,KeyboardAvoidingView} from 'react-native';
        ...
        <KeyboardAvoidingView style={{flex:1}} behavior="padding">
          ...
          <TouchableOpacity style={{width:'100%', height:RFPercentage(10),alignItems:'center', }} activeOpacity={0.8} onPress={()=>NavigationService.navigate("Cart")}>
              ...
              <View style={{flex:1, flexDirection:'column'}}>
                <ScrollView style={{flex:1, width:'100%', flexDirection:'column',  backgroundColor:'#eeffff'}}>
                  <View style={{flexDirection:'row',paddingHorizontal:10, backgroundColor:'#eeffff'}}>
                    <Text style={{flex:1, textAlign:'left', color:'#000', fontSize:RFPercentage(2.8)}}>DELIVERY ADDRESS</Text>
                    <TouchableOpacity style={{flex:1}} onPress={()=>NavigationService.navigate('DeliverySign')}>
                      <Text style={{textAlign:'right', color:'#6db0b8', fontSize:RFPercentage(2.8)}}>Change address</Text>
                    </TouchableOpacity>
                  </View>
                  <View style={{width:'100%', paddingVertical:5,paddingHorizontal:10, flexDirection:'row',  backgroundColor:'#fff',alignItems:'center'}}>
                      ...
                      <Text style={{ textAlign:'left', color:'#000', fontSize:RFPercentage(2.8), marginLeft:10}}>{global.signup.data.street+" "+global.signup.data.address+" "+global.signup.data.city+" "+global.signup.data.state}</Text>
                  </View>
                  <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
                    ...
                    <FlatList style={{width:'100%', backgroundColor:'#eeffff'}}
                      ...
                      <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
                          ...
                          <Text style={{textAlign:'right', fontSize:RFPercentage(2.8), flex:1}}> ${this.state.fee.toFixed(2)} </Text>
                      </View>
                      <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
              ...
              <SafeAreaView style={{width:'100%',padding:RFPercentage(1), backgroundColor:'#eeffff'}}>
                <View style={{width:'100%', height:RFPercentage(8), backgroundColor:'#43bc55',borderRadius:RFPercentage(1), flexDirection:'row'}}>
                  <TouchableOpacity onPress={()=>this.onGotoOrder()} style={{flex:1, padding:5, flexDirection:'row', justifyContents:'center'}}>
                    ...
                    <View  style={{backgroundColor:'#44aa44', justifyContent: 'center', borderRadius:3,}}>
                      <Text style={{color:'#fff', fontSize:RFPercentage(2.4), textAlign:'center', textAlignVertical:'center',  paddingHorizontal:5 }}>${this.getTotalCost(this.state.discount).toFixed(2)}</Text> 
                    </View>
                  </TouchableOpacity>
                </View>
              </SafeAreaView>
