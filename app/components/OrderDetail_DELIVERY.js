              ...
              <View style={{flex:1, flexDirection:'column'}}>
                <ScrollView style={{flex:1, width:'100%', flexDirection:'column',  backgroundColor:'#eeffff'}}>
                  <View style={{flexDirection:'row',paddingHorizontal:10, backgroundColor:'#eeffff'}}>
                    <Text style={{flex:1, textAlign:'left', color:'#000', fontSize:18}}>DELIVERY ADDRESS</Text>
                    <TouchableOpacity style={{flex:1}} onPress={()=>NavigationService.navigate('DeliverySign')}>
                      <Text style={{textAlign:'right', color:'#6db0b8', fontSize:18}}>Change address</Text>
                    </TouchableOpacity>
                  </View>
                  <View style={{width:'100%', paddingVertical:5,paddingHorizontal:10, flexDirection:'row',  backgroundColor:'#fff',alignItems:'center'}}>
                      ...
                      <Text style={{ textAlign:'left', color:'#000', fontSize:18, marginLeft:10}}>{global.signup.data.street+" "+global.signup.data.address+" "+global.signup.data.city+" "+global.signup.data.state}</Text>
                  </View>
                  <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
                    ...
                    <FlatList style={{width:'100%', backgroundColor:'#eeffff'}}
                      ...
                      <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
                          ...
                          <Text style={{textAlign:'right', fontSize:18, flex:1}}> ${this.state.fee.toFixed(2)} </Text>
                      </View>
                      <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
