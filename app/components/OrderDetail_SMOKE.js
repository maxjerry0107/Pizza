            ...
            {              
              ...
              Toast.show('Success!' + res.message, {
                ...
                onHidden: () => {
                  global.signup=[];
                  global.mycart=[];
                  NavigationService.navigate("OrderTracking",{orderid:orderid, product_type:2});
                }
              });
            }
            else{
            ...
            <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
              <ScrollView style={{flex:1, width:'100%', flexDirection:'column', backgroundColor:'#eeffff', }}>
                <View style={{flexDirection:'row',paddingHorizontal:10,}}>
                  <Text style={{flex:1, textAlign:'left', color:'#000', fontSize:RFPercentage(2.6)}}>GIFT SHOP</Text>
                </View>
                <View style={{width:'100%', paddingVertical:5,paddingHorizontal:10, backgroundColor:'#fff', flexDirection:'row', alignItems:'center'}}>
                   <Icon type="FontAwesome5" name='mobile-alt' style={{fontSize:RFPercentage(2.8), marginLeft:10,}}></Icon>
                    <Text style={{ textAlign:'left', color:'#000', fontSize:RFPercentage(2.8), marginLeft:5,}}>{global.myphonenumber}</Text>
                </View>
                <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
                  ...
                  <FlatList style={{width:'100%', backgroundColor:'#eeffff'}}
                    ...
                    <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
                        ...
                        <Text style={{textAlign:'right', fontSize:RFPercentage(2.8), flex:1}}> ${(this.calculateSubTotal()*this.state.vat).toFixed(2)} </Text>
                    </View>
                    <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,}}>
                    ...
                    <View style={{backgroundColor:'#fff', flexDirection:'row',paddingHorizontal:10,marginTop:5,paddingVertical:5,borderTopWidth:0.5,borderBottomWidth:0.5}}>
                        ...
                        <Text style={{textAlign:'right', fontSize:RFPercentage(2.8), flex:1}}>${this.getTotalCost().toFixed(2)}  </Text>
                    </View>
