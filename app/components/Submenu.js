...
export default class Submenu extends Component {
  ...
  getList = keyword => {
    ...
    if (keyword == "") {
      ...
      url =
        "?req=product-search&categories_id=" + catId + "&keyword=" + keyword;
    }
      ...
      .then(response => {
        ...
        if (res.status == true) {
          ...
          this.setState({
            ...
            serviceItems: res.products
          });
          if (keyword != "") this.setState({ menuname: "Search Results" });
  ...
  _renderItem({ item, index }) {
    return <SliderEntry data={item} key={index} />;
  }
