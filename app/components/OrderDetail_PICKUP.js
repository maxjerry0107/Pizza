...
export default class OrderDetail_PICKUP extends Component { 
 ...
 //   sum = sum * (100 - Number(discount)) / 100;
  ...
  onGotoOrder=()=>{
    ...
    global.signup.vat=this.calculateSubTotal() * (100 - Number(this.state.discount)) / 100 * this.state.vat;
            ...
            <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
              <ScrollView style={{flex:1, width:'100%', flexDirection:'column', backgroundColor:'#eeffff', }}>
                <View style={{flexDirection:'row',paddingHorizontal:10,}}>
                  <Text style={{flex:1, textAlign:'left', color:'#000', fontSize:RFPercentage(2.6)}}>PICKUP INFORMATION</Text>
                  <TouchableOpacity style={{flex:1}} onPress={()=>NavigationService.navigate('PickupSign', {return:'true'})}>
                ...
                <View style={{width:'100%', paddingVertical:5,paddingHorizontal:10, backgroundColor:'#fff', flexDirection:'row', alignItems:'center'}}>
                    <Icon type="FontAwesome" name='user' style={{fontSize:RFPercentage(3)}}></Icon>
                    ...
                    <Icon type="MaterialIcons" name='access-time' style={{fontSize:RFPercentage(3), marginLeft:10,}}></Icon>
                    <Text style={{ textAlign:'left', color:'#000', fontSize:RFPercentage(2.8), marginLeft:5,}}>{global.signup.data.time}</Text>
                </View>
                <View style={{flex:1, flexDirection:'column', backgroundColor:'#eeffff'}}>
