...
export default class OrderDetail_PICKUP extends Component {
  ...
  onGotoOrder = () => {
    ...
    global.signup.vat =
      ((this.calculateSubTotal() * (100 - Number(this.state.discount))) / 100) *
      this.state.vat;
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {global.signup.data.first + " " + global.signup.data.second}
                  </Text>
                  <Icon
                    type="FontAwesome5"
                    name="mobile-alt"
                  ...
                  >
                    {global.signup.data.phonenum}
                  </Text>
                  <Icon
                    type="MaterialIcons"
                    name="access-time"
                    style={{ fontSize: RFPercentage(3), marginLeft: 10 }}
                  ></Icon>
                  <Text
                    style={{
                      textAlign: "left",
